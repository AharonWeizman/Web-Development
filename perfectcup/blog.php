...
<body>
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-lg-12 text-center">
                    ...
                    <button type="button" class="btn btn-info btn-lg" data-toggle="modal"
							data-target="#myModal2">Read more
					</button>
                    <hr>
                </div>
                <div class="col-lg-12 text-center">
                    ...
                    <h2>FROZEN CARAMEL COFFEE
                        <br>
                        <small>december 23, 2017</small>
                    </h2>
                    <p>Sweetend with caramel sauce and topped 	with wipped cream, this will make you happy any time of day.</p>
					<button type="button" class="btn btn-info btn-lg" data-toggle="modal"
							data-target="#myModal3">Read more
					</button>
                    <hr>
                </div>
                <div class="col-lg-12 text-center">
	...
	<!-- create the button model refernce -->
	<!-- model 1 -->
